...
# Install dependencies (includes vLLM — Qwen3 is natively supported)
...
snapshot_download('Qwen/Qwen3-14B', local_dir='/app/models/Qwen3-14B', local_dir_use_symlinks=False)"
